...
def get_cw_adv_samples(model, images, labels, iterations=100, steps=10, tensorboard_path=None):
    ...
    labels = K.argmax(labels, axis=1).numpy()
    adversarial = attack(images, labels, binary_search_steps=steps, max_iterations=iterations, confidence=1, learning_rate=0.5, initial_const=0.01, abort_early=True)
